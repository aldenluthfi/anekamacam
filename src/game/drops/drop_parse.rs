...
/// present on those squares. If all of them are, then the drop is legal.
///
/// The stoppers compound is also a compound atomic in CKN. All singular vectors
/// generated by the stoppers are checked to see if [pieces] are not present on
/// those squares. If any of them are, then the drop is illegal.
///

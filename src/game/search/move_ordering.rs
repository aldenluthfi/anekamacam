...
///
/// A selection-sort step used inside alpha-beta's move loop to avoid sorting
/// the entire move list up front. Combined with cutoffs, this typically
/// performs fewer comparisons and allocations than full sorting.
///
